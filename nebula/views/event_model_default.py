...
from ..dao.event_model_dao import EventModelDefaultDao
...
logger = logging.getLogger('nebula.api.event_model_default')
...
class EventModelListHandler(BaseHandler):
    REST_URL = "/default/event_models"
...
class EventQueryHandler(BaseHandler):
    ...
    REST_URL = "/default/event_models/event/{app}/{name}"
